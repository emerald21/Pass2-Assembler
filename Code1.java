...
public class Code1  {
	...
	File sym = new File("/home/aditi/try/sym.txt");
	
	BufferedReader br2 = new BufferedReader(new FileReader(sym));
	
	File lit = new File("/home/aditi/try/lit.txt");
	...
	File tc1=new File("/home/aditi/try/tc.txt");
	
	if(tc1.exists()){
		tc1.delete();
	}
	File tc=new File("/home/aditi/try/tc.txt");
	//ArrayList<ArrayList> tokens=new ArrayList<ArrayList>();
